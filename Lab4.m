...
%% 2 De olika belysningarna i xy planet
...
%% 4 Plotta spektralfördelningen för samtliga belysningar
...
%% 6a Konvertera belysningen till CIEXYZ 
XYZ6 = colorsignal2xyz(R1, CIEB);
XYZ7 = colorsignal2xyz(R1, plank90k);
XYZ8 = colorsignal2xyz(R1, Tungsten60W);
plot3(XYZ6(1), XYZ6(2), XYZ6(3), 'k +');
hold on
